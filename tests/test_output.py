...
class TestOutput(unittest.TestCase):
    ...
    def test_print(self):
        ...
        self.assertOutputRegex(
            r"time,\s+merge\:\s+312.47721968\d{6}\/6.644640850\d{6}\s+1\.3742083125\d{6}\s+\+\s+6\.698080399\d{6}\s+\*\s+log2\(y\)\^\(1\)\s+\+\s+0\.04384165529\d{6}\s+\*\s+x\^\(3\/2\)\s+\*\s+log2\(x\)\^\(2\)\s+\*\s+log2\(y\)\^\(1\)\s+"
            r"time,\s+sort\:\s+312.47721968\d{6}\/6.644640850\d{6}\s+1\.3742083125\d{6}\s+\+\s+6\.698080399\d{6}\s+\*\s+log2\(y\)\^\(1\)\s+\+\s+0\.04384165529\d{6}\s+\*\s+x\^\(3\/2\)\s+\*\s+log2\(x\)\^\(2\)\s+\*\s+log2\(y\)\^\(1\)\s+"
            r"flops,\s+merge\:\s+312.47721968\d{6}\/6.644640850\d{6}\s+1\.3742083125\d{6}\s+\+\s+6\.698080399\d{6}\s+\*\s+log2\(y\)\^\(1\)\s+\+\s+0\.04384165529\d{6}\s+\*\s+x\^\(3\/2\)\s+\*\s+log2\(x\)\^\(2\)\s+\*\s+log2\(y\)\^\(1\)\s+"
            r"flops,\s+sort\:\s+312.47721968\d{6}\/6.644640850\d{6}\s+1\.3742083125\d{6}\s+\+\s+6\.698080399\d{6}\s+\*\s+log2\(y\)\^\(1\)\s+\+\s+0\.04384165529\d{6}\s+\*\s+x\^\(3\/2\)\s+\*\s+log2\(x\)\^\(2\)\s+\*\s+log2\(y\)\^\(1\)",
            extrap.main,
