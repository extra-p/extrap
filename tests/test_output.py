...
class TestOutput(unittest.TestCase):
    ...
    def test_print(self):
        ...
        #"312\.47721968273936/6\.644640850035617 1\.374208312529971\+6\.698080399962684\*log2\(y\)\*\*\(1\)\+0\.043841655290305426\*x\*\*\(3/2\)\*log2\(x\)\*\*\(2\)\*log2\(y\)\*\*\(1\)"
        self.assertOutputRegex(
            r"time,\s+merge\:\s+312\.477219\d+/6\.644640\d+ 1\.374208\d+\+6\.698080\d+\*log2\(y\)\*\*\(1\)\+0\.043841\d+\*x\*\*\(3/2\)\*log2\(x\)\*\*\(2\)\*log2\(y\)\*\*\(1\)\s+"
            r"time,\s+sort\:\s+312\.477219\d+/6\.644640\d+ 1\.374208\d+\+6\.698080\d+\*log2\(y\)\*\*\(1\)\+0\.043841\d+\*x\*\*\(3/2\)\*log2\(x\)\*\*\(2\)\*log2\(y\)\*\*\(1\)\s+"
            r"flops,\s+merge\:\s+312\.477219\d+/6\.644640\d+ 1\.374208\d+\+6\.698080\d+\*log2\(y\)\*\*\(1\)\+0\.043841\d+\*x\*\*\(3/2\)\*log2\(x\)\*\*\(2\)\*log2\(y\)\*\*\(1\)\s+"
            r"flops,\s+sort\:\s+312\.477219\d+/6\.644640\d+ 1\.374208\d+\+6\.698080\d+\*log2\(y\)\*\*\(1\)\+0\.043841\d+\*x\*\*\(3/2\)\*log2\(x\)\*\*\(2\)\*log2\(y\)\*\*\(1\)",
            extrap.main,
