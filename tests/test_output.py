...
class TestOutput(unittest.TestCase):
    ...
    def test_model_latex(self):
        regex = (
            r"time,\ merge:\ 312\.47721968\d{5,7}/6\.644640850\d{5,7}\ \$1\.374\+6\.698\\cdot\ \\log_2\{y\}\^\{1\.0\}\+"
            r"4\.384\\times10\^\{−2\}\\cdot\ x\^\{3/2\}\\cdot\ \\log_2\{x\}\^\{2\.0\}\\cdot\ \\log_2\{y\}\^\{1\.0\}\$\s+"
            r"time,\ sort:\ 312\.47721968\d{5,7}/6\.644640850\d{5,7}\ \$1\.374\+6\.698\\cdot\ \\log_2\{y\}\^\{1\.0\}\+"
            r"4\.384\\times10\^\{−2\}\\cdot\ x\^\{3/2\}\\cdot\ \\log_2\{x\}\^\{2\.0\}\\cdot\ \\log_2\{y\}\^\{1\.0\}\$\s+"
            r"flops,\ merge:\ 312\.47721968\d{5,7}/6\.644640850\d{5,7}\ \$1\.374\+6\.698\\cdot\ \\log_2\{y\}\^\{1\.0\}\+"
            r"4\.384\\times10\^\{−2\}\\cdot\ x\^\{3/2\}\\cdot\ \\log_2\{x\}\^\{2\.0\}\\cdot\ \\log_2\{y\}\^\{1\.0\}\$\s+"
            r"flops,\ sort:\ 312\.477219682\d{5,7}/6\.644640850\d{5,7}\ \$1\.374\+6\.698\\cdot\ \\log_2\{y\}\^\{1\.0\}\+"
