...
__title__ = "Extra-P"
__version__ = "4.3.0-alpha3"
__description__ = "Extra-P, automated performance modeling for HPC applications"
__copyright__ = "Copyright (c) 2020-2025 Technical University of Darmstadt, Darmstadt, Germany"
...
__developed_by_html__ = 'Extra-P is developed by <a href="https://www.parallel.informatik.tu-darmstadt.de/">' \
                        'TU Darmstadt</a> – in collaboration with <a href="https://spcl.inf.ethz.ch/">ETH Zurich</a>.'
