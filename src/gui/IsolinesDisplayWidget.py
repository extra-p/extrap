...
class IsolinesDisplayWidget(QWidget):
...
#####################################################################
    ...
    def __init__(self, main_widget, parent):
        super(IsolinesDisplayWidget, self).__init__(parent)
    ...
    def setMax(self, axis, maxValue):
        """ This function sets the highest value of x and y that is being shown on x and axis.
        """
        if axis == 0:
