...
> **Note**  
> Extra-P is designed for weak-scaling. Therfore directly modeling of strong-scaling behaviour is not supported.
> Instead of modeling the runtime of your strong-scaling experiment, you can model the resource utilization, i.e.,
